...
Controller<TestClassEmbedded, EmbeddableCompositeKey>
{
	...
	public Object create(@PathParam("emKey1") int emKey1, @PathParam("emKey2") String emKey2, @PathParam("emKey3") Date emKey3, TestClassEmbeddedWrap aWrap) throws Exception {
		TestClassEmbeddedWrapper aModel = aWrap.testClassEmbedded;
	...
	@PUT
	@Path("/{emKey1}::{emKey2}::{emKey3}")
	public Object update(@PathParam("emKey1") int emKey1, @PathParam("emKey2") String emKey2, @PathParam("emKey3") Date emKey3, TestClassEmbeddedWrap aWrap) throws Exception {
		TestClassEmbeddedWrapper aModel = aWrap.testClassEmbedded;
		EmbeddableCompositeKey embId = new EmbeddableCompositeKey();
		embId.emKey1 = emKey1;
		embId.emKey2 = emKey2;
	...
	public static Object wrapAll(Map<?, TestClassEmbedded> aMap) {
		...
		return new Object(){ @JsonProperty Map<Object, TestClassEmbeddedWrapper> embeddeds = allWrapped; };
	};
	
	public static TestClassEmbeddedWrap wrap(final TestClassEmbedded aResult) {
		return new TestClassEmbeddedWrap(aResult);
	}
	
	static class TestClassEmbeddedWrap {
		@JsonProperty TestClassEmbeddedWrapper testClassEmbedded;
		
		public TestClassEmbeddedWrap() { this(new TestClassEmbedded()); };
		public TestClassEmbeddedWrap(TestClassEmbedded aWrappable) { testClassEmbedded = new TestClassEmbeddedWrapper(aWrappable); };
	}
