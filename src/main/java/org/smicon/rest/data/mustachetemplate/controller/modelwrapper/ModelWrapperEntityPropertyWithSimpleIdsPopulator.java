...
ModelWrapperSimplePropertyPopulator
{
	...
	public ModelWrapperEntityPropertyWithSimpleIdsPopulator(EntityPropertyMeta aEntityPropertyMeta, ModelMetaRegistryI aRegistry) throws Exception {
		super(aEntityPropertyMeta.getPropertyDescriptor(), aRegistry);
		this.entityPropertyMeta = aEntityPropertyMeta;
		
		if(!(this.entityPropertyMeta.getChildMeta() instanceof ModelMeta))
		{
