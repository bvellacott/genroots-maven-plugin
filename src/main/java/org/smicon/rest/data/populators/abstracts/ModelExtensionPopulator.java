...
TemplatePopulator
{
	...
	ModelMeta modelEntityMeta;
	EntityValidationDataI validationData;
	ModelMetaRegistryI registry;
	EmberModelTypeConfigurationI configuration;

	public ModelExtensionPopulator(ModelMeta aMeta, EntityValidationDataI aData, ModelMetaRegistryI aRegistry, EmberModelTypeConfigurationI aConfiguration) throws Exception
	{
		this.modelEntityMeta = aMeta;
		this.validationData = aData;
		this.registry = aRegistry;
		this.configuration = aConfiguration;
	}

	public ModelMeta getModelEntityMeta()
	{
		return modelEntityMeta;
	}
	
	public EntityValidationDataI getValidationData()
	{
	...
	public void setModelEntityMeta(ModelMeta modelEntityMeta)
	{
		this.modelEntityMeta = modelEntityMeta;
	}

	public void setValidationData(EntityValidationDataI validationData)
	{
		this.validationData = validationData;
	}

	public void setRegistry(ModelMetaRegistryI registry)
	{
	...
	{
		return this.getModelEntityMeta().getEntityClass().getPackage().getName();
	}

	public String getClassName()
	{
		return this.getModelEntityMeta().getEntityClass().getSimpleName();
	}
	...
	public String getImports()
	{
		...
		{
			addNonPrimitiveTypeToSet(imports, propMeta.getChildMeta().getEntityClass());
	...
	public static String generateSetterLine(String aSubjectName, BeanInfo aSubjectInfo, String aParamName, Class<?> aIdType, EntityValidationDataI aValidationData) throws Exception
	{
		if (EntityValidationFunctions.isValidSimpleIdType(aIdType, aValidationData))
		{
		...
		else
		{
			...
			throw new IncorrectIdStructureException("The composite type: " + aIdType + " doesn't contain a field or accessor for a field by the name: "
				+ aParamName);
		}
	}
