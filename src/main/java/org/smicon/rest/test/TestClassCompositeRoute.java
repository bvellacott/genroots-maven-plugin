...
Controller<TestClassComposite, CompositeKey>
{
	...
	@POST
	@Path("/{key1}::{key2}")
	public Object create(@PathParam("key1") int key1, @PathParam("key2") int key2, TestClassCompositeWrapper aModel) throws Exception {
		aModel.setKey1(key1);
		aModel.setKey2(key2);
	...
	@PUT
	@Path("/{key1}::{key2}")
	public Object update(@PathParam("key1") int key1, @PathParam("key2") int key2, TestClassCompositeWrapper aModel) throws Exception {
		aModel.setKey1(key1);
		aModel.setKey2(key2);
	...
	public static Object wrap(final TestClassComposite aResult) {
		return new Object(){ @JsonProperty TestClassCompositeWrapper testclasscomposite = new TestClassCompositeWrapper(aResult);};
	}
